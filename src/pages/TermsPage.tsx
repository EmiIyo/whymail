      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="prose prose-sm max-w-none space-y-5 text-foreground/90 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>We aim for high availability but make no SLA guarantee. Mail delivery depends on Cloudflare (Email Routing for inbound, Email Sending for outbound) and may be delayed or rejected by them.</p>
          </section>
